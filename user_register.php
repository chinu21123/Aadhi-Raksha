...
if(empty($get_name) || empty($get_email) || empty($get_password) )
{
	$response["success"] = 2;
...
else
{
	...
	// get customer 
	$result1 = mysqli_query($conn,"INSERT INTO login (name, email, password, mobile,field_1,field_2,field_3,field_4,field_9, created_date)
			VALUES('$get_name',  '$get_email', '$get_password', '$get_mobile', 	'$get_field_1',
			'$get_field_2','$get_field_3','$get_field_4','$get_field_9','$get_created_date'	)");
